...
The step that hasn’t been talked about was the CORS permissions. This can be found under a separate tab next to the Bucket Policy tab, called CORS configuration . You may have it set to be:
